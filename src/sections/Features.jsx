...
const Tile = (props) => {
  return (
    <div className="">
      ...
      <p className="text-justify text-[12.8px] tight-letter-spacing break-words  tracking-tighter lg:text-justify md:text-[13px] lg:text-[13px] mt-6 lg:tracking-tighter ">
        {props.text}
      </p>
    </div>
  );
